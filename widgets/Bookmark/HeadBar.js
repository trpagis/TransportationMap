  ...
  function (Evented, declare, lang, html, on,/* SpatialReference,*/
    ...
    return declare([_WidgetBase, _TemplatedMixin, _WidgetsInTemplateMixin, Evented], {
      ...
      startup: function () {
        ...
        //default config for update old version
        // if ("undefined" === typeof this.editable) {
        //   this.editable = true;
        // }
        // if ("undefined" === typeof this.layout) {
        //   this.layout = {};
        //   this.layout.cards = true;
        //   this.layout.list = false;
        //   this.layout.defaultMode = "cards";
        // }
        this.refreshUI();
      ...
      cardsMode: function () {
        ...
        //utils.setLastLayout("cards");//use default layout in config, only
      ...
      listMode: function () {
        ...
        //utils.setLastLayout("list");//use default layout in config, only
