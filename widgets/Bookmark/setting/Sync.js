  ...
  function (declare, lang, array, keys, BaseWidgetSetting, _WidgetsInTemplateMixin,
    ...
    var clazz = declare([BaseWidgetSetting, _WidgetsInTemplateMixin], {
      ...
      startup: function () {
        ...
        // this.own(on(this.syncFromWebmap, 'click', lang.hitch(this, function () {
        //   this.showBookmarksFromWebmap();
        // })));
        // this.own(on(this.syncFromConfig, 'click', lang.hitch(this, function () {
        //   this.showBookmarksFromConfig();
        // })));
      ...
      showWebmapBookmarks: function () {
        // this._cacheBM = utils.cloneBookmarksDataWithOutDom(this._bookmarksInWebmap);
        // if (this._cacheBM && this._cacheBM.length && this._cacheBM.length > 0) {
        //   this.empty(this._bookmarksInWebmap);
        // }
      ...
      setConfig: function (config) {
        ...
        //   //this.config.isConfigBefore5_3 = true;//TODO flag
        ...
        // //var bookmarks = [];
        // if(true === this._NEED_TO_UPDATE){
        //   //bookmarks = lang.clone(this.config.bookmarks2D);
        //   //bookmarks = utils.webmapBookmarkFilter(bookmarks, this.map);
      ...
      getConfig: function () {
        ...
        //if (this.config.syncMode.webmap) {
        //bookmarks = bookmarks.concat(this._bookmarksInWebmap);
        //}
        //if (this.config.syncMode.custom) {
      ...
      //   bookmarks = tmp;
      //   //html.empty(this.bookMarkerContainer);
      // },
      ...
      // setSortableDisable: function () {
      //   if (this.sortableBookMarkerNodes) {
      //     if (this._syncMode === "webmap") {
      //       this.sortableBookMarkerNodes.option("disabled", true);
      //     } else if (this._syncMode === "custom") {
