  ...
  function (Evented, declare, lang, html, array, on, has,// query,
    ...
    return declare([BaseWidget, _TemplatedMixin, Evented], {
      ...
      refresh: function (localCache) {
        ...
        // if (true !== readOnceFlag/*utils.isConfigBefore5_3(this.config)*//* && true !== utils.isCacheKeyUpdatedy(this.widgetId)*/) {
        //   //old config need to update
        //   //console.log("==> updated bookmarks");
        //   //this.bookmarks = utils.webmapBookmarkFilter(bookmarks, this.map);

        //   //compare with config
        //   this.bookmarks = utils.filterBookmarkFromTarget(bookmarks, this.config.bookmarks2D);
        //   //set a flag in cache
        //   /*utils.setUpdateCacheKey(this.widgetId);*/
        // } else {
        ...
        //   (this.config && false === this.config.editable)) {
        //   //without cache && false==editable
      ...
      _onBookmarkDeleteImmediately: function (bookmark) {
        //this.removeSelectedBookMarks(bookmark);
