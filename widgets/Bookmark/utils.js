...
define([
  ...
  function (lang, /*on,Deferred, */array, html, /*keys, */jimuUtils, ItemNode,
    ...
    mo.getAutoRenameBeforeAdd = function (newBookmarkName, bookmarks) {
      var sumNum = 0;
      ...
      array.forEach(bookmarks, function (bookmark) {
        ...
        //same bookmark.name, but displayName is increased
        if (-1 !== bookmark.name.indexOf(newBookmarkName)) {
          //get (num) by RegExp
    ...
    //LayerInfos
    mo.layerInfosRestoreState = function (layerOptions) {
