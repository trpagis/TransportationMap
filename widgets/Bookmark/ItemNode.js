  ...
  function (Evented, declare, lang, html,// array,
    ...
    In = declare([BaseWidget, _WidgetsInTemplateMixin, Evented], {
      ...
      postCreate: function () {
        ...
        this.nodeLabel.setValue(utils.sanitizeHTML(this.label));
        //this._LAST_VALUE = utils.sanitizeHTML(this.label);
        //html.setAttr(this.nodeLabel, 'title', utils.sanitizeHTML(this.label));
      ...
      _updateLabelTooltips: function (tips) {
        ...
        html.setAttr(this.nodeLabel, 'title', str);
        if (this.dragMasker) {
          html.setAttr(this.dragMasker, 'title', str);
        }
      }
    });
